...
INSERT INTO `address` VALUES (1,1,'riyadh','chowdhury','','mohammadpur','','dhak','1230',18,322,'');
...
--
-- Table structure for table `amazon_login_pay_order`
--

DROP TABLE IF EXISTS `amazon_login_pay_order`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `amazon_login_pay_order` (
...
--
-- Dumping data for table `amazon_login_pay_order`
--

LOCK TABLES `amazon_login_pay_order` WRITE;
/*!40000 ALTER TABLE `amazon_login_pay_order` DISABLE KEYS */;
/*!40000 ALTER TABLE `amazon_login_pay_order` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `amazon_login_pay_order_total_tax`
--

DROP TABLE IF EXISTS `amazon_login_pay_order_total_tax`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `amazon_login_pay_order_total_tax` (
...
--
-- Dumping data for table `amazon_login_pay_order_total_tax`
--

LOCK TABLES `amazon_login_pay_order_total_tax` WRITE;
/*!40000 ALTER TABLE `amazon_login_pay_order_total_tax` DISABLE KEYS */;
/*!40000 ALTER TABLE `amazon_login_pay_order_total_tax` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `amazon_login_pay_order_transaction`
--

DROP TABLE IF EXISTS `amazon_login_pay_order_transaction`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `amazon_login_pay_order_transaction` (
...
--
-- Dumping data for table `amazon_login_pay_order_transaction`
--

LOCK TABLES `amazon_login_pay_order_transaction` WRITE;
/*!40000 ALTER TABLE `amazon_login_pay_order_transaction` DISABLE KEYS */;
/*!40000 ALTER TABLE `amazon_login_pay_order_transaction` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `api` VALUES (1,'Default','',1,'2016-02-02 14:31:29','2016-02-02 14:31:29');
...
INSERT INTO `cart` VALUES (2,1,'ar7q3382lve4s42cv1f011qh33',43,0,'[]',1,'2016-02-02 14:39:33');
...
INSERT INTO `currency` VALUES (4,'Bangladeshi Taka','BDT','৳','','2',1.00000000,1,'2016-02-03 17:29:37');
...
INSERT INTO `customer` VALUES (1,1,0,'riyadh','chowdhury','riyadh.iut@hotmail.com','0175554433445','','87ecd54ff97f4cbccc89bfec05f985a3ec650dd4','ymZcC5JhF',NULL,NULL,0,1,'','103.245.206.118',1,1,0,'','2016-02-02 14:39:32');
...
INSERT INTO `customer_activity` VALUES (1,1,'register','{\"customer_id\":1,\"name\":\"riyadh chowdhury\"}','103.245.206.118','2016-02-02 14:39:32');
...
INSERT INTO `customer_ip` VALUES (1,1,'103.245.206.118','2016-02-02 14:39:33');
...
INSERT INTO `customer_wishlist` VALUES (1,42,'2016-02-02 14:41:11');
...
INSERT INTO `event` VALUES (1,'voucher','post.order.history.add','total/voucher/send'),(2,'amazon_edit_capture','post.order.edit','payment/amazon_login_pay/capture'),(3,'amazon_history_capture','post.order.history.add','payment/amazon_login_pay/capture');
...
INSERT INTO `setting` VALUES (1,0,'shipping','shipping_sort_order','3',0),(2,0,'sub_total','sub_total_sort_order','1',0),(3,0,'sub_total','sub_total_status','1',0),(4,0,'tax','tax_status','1',0),(5,0,'total','total_sort_order','9',0),(6,0,'total','total_status','1',0),(7,0,'tax','tax_sort_order','5',0),(8,0,'free_checkout','free_checkout_sort_order','1',0),(9,0,'cod','cod_sort_order','5',0),(10,0,'cod','cod_total','0.01',0),(11,0,'cod','cod_order_status_id','1',0),(12,0,'cod','cod_geo_zone_id','0',0),(13,0,'cod','cod_status','1',0),(14,0,'shipping','shipping_status','1',0),(15,0,'shipping','shipping_estimator','1',0),(27,0,'coupon','coupon_sort_order','4',0),(28,0,'coupon','coupon_status','1',0),(34,0,'flat','flat_sort_order','1',0),(35,0,'flat','flat_status','1',0),(36,0,'flat','flat_geo_zone_id','0',0),(37,0,'flat','flat_tax_class_id','9',0),(41,0,'flat','flat_cost','5.00',0),(42,0,'credit','credit_sort_order','7',0),(43,0,'credit','credit_status','1',0),(53,0,'reward','reward_sort_order','2',0),(54,0,'reward','reward_status','1',0),(146,0,'category','category_status','1',0),(158,0,'account','account_status','1',0),(159,0,'affiliate','affiliate_status','1',0),(624,0,'config','config_robots','abot\r\ndbot\r\nebot\r\nhbot\r\nkbot\r\nlbot\r\nmbot\r\nnbot\r\nobot\r\npbot\r\nrbot\r\nsbot\r\ntbot\r\nvbot\r\nybot\r\nzbot\r\nbot.\r\nbot/\r\n_bot\r\n.bot\r\n/bot\r\n-bot\r\n:bot\r\n(bot\r\ncrawl\r\nslurp\r\nspider\r\nseek\r\naccoona\r\nacoon\r\nadressendeutschland\r\nah-ha.com\r\nahoy\r\naltavista\r\nananzi\r\nanthill\r\nappie\r\narachnophilia\r\narale\r\naraneo\r\naranha\r\narchitext\r\naretha\r\narks\r\nasterias\r\natlocal\r\natn\r\natomz\r\naugurfind\r\nbackrub\r\nbannana_bot\r\nbaypup\r\nbdfetch\r\nbig brother\r\nbiglotron\r\nbjaaland\r\nblackwidow\r\nblaiz\r\nblog\r\nblo.\r\nbloodhound\r\nboitho\r\nbooch\r\nbradley\r\nbutterfly\r\ncalif\r\ncassandra\r\nccubee\r\ncfetch\r\ncharlotte\r\nchurl\r\ncienciaficcion\r\ncmc\r\ncollective\r\ncomagent\r\ncombine\r\ncomputingsite\r\ncsci\r\ncurl\r\ncusco\r\ndaumoa\r\ndeepindex\r\ndelorie\r\ndepspid\r\ndeweb\r\ndie blinde kuh\r\ndigger\r\nditto\r\ndmoz\r\ndocomo\r\ndownload express\r\ndtaagent\r\ndwcp\r\nebiness\r\nebingbong\r\ne-collector\r\nejupiter\r\nemacs-w3 search engine\r\nesther\r\nevliya celebi\r\nezresult\r\nfalcon\r\nfelix ide\r\nferret\r\nfetchrover\r\nfido\r\nfindlinks\r\nfireball\r\nfish search\r\nfouineur\r\nfunnelweb\r\ngazz\r\ngcreep\r\ngenieknows\r\ngetterroboplus\r\ngeturl\r\nglx\r\ngoforit\r\ngolem\r\ngrabber\r\ngrapnel\r\ngralon\r\ngriffon\r\ngromit\r\ngrub\r\ngulliver\r\nhamahakki\r\nharvest\r\nhavindex\r\nhelix\r\nheritrix\r\nhku www octopus\r\nhomerweb\r\nhtdig\r\nhtml index\r\nhtml_analyzer\r\nhtmlgobble\r\nhubater\r\nhyper-decontextualizer\r\nia_archiver\r\nibm_planetwide\r\nichiro\r\niconsurf\r\niltrovatore\r\nimage.kapsi.net\r\nimagelock\r\nincywincy\r\nindexer\r\ninfobee\r\ninformant\r\ningrid\r\ninktomisearch.com\r\ninspector web\r\nintelliagent\r\ninternet shinchakubin\r\nip3000\r\niron33\r\nisraeli-search\r\nivia\r\njack\r\njakarta\r\njavabee\r\njetbot\r\njumpstation\r\nkatipo\r\nkdd-explorer\r\nkilroy\r\nknowledge\r\nkototoi\r\nkretrieve\r\nlabelgrabber\r\nlachesis\r\nlarbin\r\nlegs\r\nlibwww\r\nlinkalarm\r\nlink validator\r\nlinkscan\r\nlockon\r\nlwp\r\nlycos\r\nmagpie\r\nmantraagent\r\nmapoftheinternet\r\nmarvin/\r\nmattie\r\nmediafox\r\nmediapartners\r\nmercator\r\nmerzscope\r\nmicrosoft url control\r\nminirank\r\nmiva\r\nmj12\r\nmnogosearch\r\nmoget\r\nmonster\r\nmoose\r\nmotor\r\nmultitext\r\nmuncher\r\nmuscatferret\r\nmwd.search\r\nmyweb\r\nnajdi\r\nnameprotect\r\nnationaldirectory\r\nnazilla\r\nncsa beta\r\nnec-meshexplorer\r\nnederland.zoek\r\nnetcarta webmap engine\r\nnetmechanic\r\nnetresearchserver\r\nnetscoop\r\nnewscan-online\r\nnhse\r\nnokia6682/\r\nnomad\r\nnoyona\r\nnutch\r\nnzexplorer\r\nobjectssearch\r\noccam\r\nomni\r\nopen text\r\nopenfind\r\nopenintelligencedata\r\norb search\r\nosis-project\r\npack rat\r\npageboy\r\npagebull\r\npage_verifier\r\npanscient\r\nparasite\r\npartnersite\r\npatric\r\npear.\r\npegasus\r\nperegrinator\r\npgp key agent\r\nphantom\r\nphpdig\r\npicosearch\r\npiltdownman\r\npimptrain\r\npinpoint\r\npioneer\r\npiranha\r\nplumtreewebaccessor\r\npogodak\r\npoirot\r\npompos\r\npoppelsdorf\r\npoppi\r\npopular iconoclast\r\npsycheclone\r\npublisher\r\npython\r\nrambler\r\nraven search\r\nroach\r\nroad runner\r\nroadhouse\r\nrobbie\r\nrobofox\r\nrobozilla\r\nrules\r\nsalty\r\nsbider\r\nscooter\r\nscoutjet\r\nscrubby\r\nsearch.\r\nsearchprocess\r\nsemanticdiscovery\r\nsenrigan\r\nsg-scout\r\nshai\'hulud\r\nshark\r\nshopwiki\r\nsidewinder\r\nsift\r\nsilk\r\nsimmany\r\nsite searcher\r\nsite valet\r\nsitetech-rover\r\nskymob.com\r\nsleek\r\nsmartwit\r\nsna-\r\nsnappy\r\nsnooper\r\nsohu\r\nspeedfind\r\nsphere\r\nsphider\r\nspinner\r\nspyder\r\nsteeler/\r\nsuke\r\nsuntek\r\nsupersnooper\r\nsurfnomore\r\nsven\r\nsygol\r\nszukacz\r\ntach black widow\r\ntarantula\r\ntempleton\r\n/teoma\r\nt-h-u-n-d-e-r-s-t-o-n-e\r\ntheophrastus\r\ntitan\r\ntitin\r\ntkwww\r\ntoutatis\r\nt-rex\r\ntutorgig\r\ntwiceler\r\ntwisted\r\nucsd\r\nudmsearch\r\nurl check\r\nupdated\r\nvagabondo\r\nvalkyrie\r\nverticrawl\r\nvictoria\r\nvision-search\r\nvolcano\r\nvoyager/\r\nvoyager-hc\r\nw3c_validator\r\nw3m2\r\nw3mir\r\nwalker\r\nwallpaper\r\nwanderer\r\nwauuu\r\nwavefire\r\nweb core\r\nweb hopper\r\nweb wombat\r\nwebbandit\r\nwebcatcher\r\nwebcopy\r\nwebfoot\r\nweblayers\r\nweblinker\r\nweblog monitor\r\nwebmirror\r\nwebmonkey\r\nwebquest\r\nwebreaper\r\nwebsitepulse\r\nwebsnarf\r\nwebstolperer\r\nwebvac\r\nwebwalk\r\nwebwatch\r\nwebwombat\r\nwebzinger\r\nwhizbang\r\nwhowhere\r\nwild ferret\r\nworldlight\r\nwwwc\r\nwwwster\r\nxenu\r\nxget\r\nxift\r\nxirq\r\nyandex\r\nyanga\r\nyeti\r\nyodao\r\nzao\r\nzippp\r\nzyborg',0),(635,0,'config','config_error_filename','error.log',0),(630,0,'config','config_file_max_size','300000',0),(631,0,'config','config_file_ext_allowed','zip\r\ntxt\r\npng\r\njpe\r\njpeg\r\njpg\r\ngif\r\nbmp\r\nico\r\ntiff\r\ntif\r\nsvg\r\nsvgz\r\nzip\r\nrar\r\nmsi\r\ncab\r\nmp3\r\nqt\r\nmov\r\npdf\r\npsd\r\nai\r\neps\r\nps\r\ndoc',0),(632,0,'config','config_file_mime_allowed','text/plain\r\nimage/png\r\nimage/jpeg\r\nimage/gif\r\nimage/bmp\r\nimage/tiff\r\nimage/svg+xml\r\napplication/zip\r\n&quot;application/zip&quot;\r\napplication/x-zip\r\n&quot;application/x-zip&quot;\r\napplication/x-zip-compressed\r\n&quot;application/x-zip-compressed&quot;\r\napplication/rar\r\n&quot;application/rar&quot;\r\napplication/x-rar\r\n&quot;application/x-rar&quot;\r\napplication/x-rar-compressed\r\n&quot;application/x-rar-compressed&quot;\r\napplication/octet-stream\r\n&quot;application/octet-stream&quot;\r\naudio/mpeg\r\nvideo/quicktime\r\napplication/pdf',0),(633,0,'config','config_error_display','1',0),(634,0,'config','config_error_log','1',0),(94,0,'voucher','voucher_sort_order','8',0),(95,0,'voucher','voucher_status','1',0),(103,0,'free_checkout','free_checkout_status','1',0),(104,0,'free_checkout','free_checkout_order_status_id','1',0),(625,0,'config','config_compression','0',0),(626,0,'config','config_secure','0',0),(627,0,'config','config_password','1',0),(628,0,'config','config_shared','0',0),(629,0,'config','config_encryption','',0),(623,0,'config','config_seo_url','0',0),(621,0,'config','config_mail_alert','',0),(622,0,'config','config_maintenance','0',0),(620,0,'config','config_mail_smtp_timeout','5',0),(619,0,'config','config_mail_smtp_port','25',0),(618,0,'config','config_mail_smtp_password','',0),(617,0,'config','config_mail_smtp_username','',0),(616,0,'config','config_mail_smtp_hostname','',0),(615,0,'config','config_mail_parameter','',0),(614,0,'config','config_mail_protocol','mail',0),(613,0,'config','config_ftp_status','0',0),(612,0,'config','config_ftp_root','',0),(611,0,'config','config_ftp_password','',0),(610,0,'config','config_ftp_username','',0),(609,0,'config','config_ftp_port','21',0),(608,0,'config','config_ftp_hostname','khokakhuki.com',0),(607,0,'config','config_image_location_height','50',0),(606,0,'config','config_image_location_width','268',0),(605,0,'config','config_image_cart_height','47',0),(604,0,'config','config_image_cart_width','47',0),(603,0,'config','config_image_wishlist_height','47',0),(601,0,'config','config_image_compare_height','90',0),(602,0,'config','config_image_wishlist_width','47',0),(600,0,'config','config_image_compare_width','90',0),(599,0,'config','config_image_related_height','80',0),(598,0,'config','config_image_related_width','80',0),(597,0,'config','config_image_additional_height','74',0),(596,0,'config','config_image_additional_width','74',0),(595,0,'config','config_image_product_height','228',0),(594,0,'config','config_image_product_width','228',0),(593,0,'config','config_image_popup_height','500',0),(592,0,'config','config_image_popup_width','500',0),(591,0,'config','config_image_thumb_height','228',0),(590,0,'config','config_image_thumb_width','228',0),(589,0,'config','config_image_category_height','80',0),(588,0,'config','config_image_category_width','80',0),(586,0,'config','config_logo','catalog/logo.png',0),(587,0,'config','config_icon','catalog/cart.png',0),(584,0,'config','config_captcha','',0),(585,0,'config','config_captcha_page','[\"review\",\"return\",\"contact\"]',1),(583,0,'config','config_return_status_id','2',0),(582,0,'config','config_return_id','0',0),(581,0,'config','config_affiliate_mail','0',0),(580,0,'config','config_affiliate_id','4',0),(579,0,'config','config_affiliate_commission','5',0),(578,0,'config','config_affiliate_auto','0',0),(576,0,'config','config_stock_checkout','0',0),(577,0,'config','config_affiliate_approval','0',0),(575,0,'config','config_stock_warning','0',0),(574,0,'config','config_stock_display','0',0),(573,0,'config','config_api_id','1',0),(572,0,'config','config_order_mail','0',0),(571,0,'config','config_fraud_status_id','7',0),(569,0,'config','config_processing_status','[\"5\",\"1\",\"2\",\"12\",\"3\"]',1),(570,0,'config','config_complete_status','[\"5\",\"3\"]',1),(568,0,'config','config_order_status_id','1',0),(567,0,'config','config_checkout_id','5',0),(566,0,'config','config_checkout_guest','1',0),(565,0,'config','config_cart_weight','1',0),(564,0,'config','config_invoice_prefix','INV-2013-00',0),(563,0,'config','config_account_mail','0',0),(562,0,'config','config_account_id','3',0),(561,0,'config','config_login_attempts','5',0),(560,0,'config','config_customer_price','0',0),(559,0,'config','config_customer_group_display','[\"1\"]',1),(558,0,'config','config_customer_group_id','1',0),(557,0,'config','config_customer_online','0',0),(556,0,'config','config_tax_customer','shipping',0),(555,0,'config','config_tax_default','shipping',0),(554,0,'config','config_tax','1',0),(553,0,'config','config_voucher_max','1000',0),(552,0,'config','config_voucher_min','1',0),(551,0,'config','config_review_mail','0',0),(550,0,'config','config_review_guest','1',0),(549,0,'config','config_review_status','1',0),(548,0,'config','config_limit_admin','20',0),(547,0,'config','config_product_description_length','100',0),(546,0,'config','config_product_limit','15',0),(545,0,'config','config_product_count','1',0),(544,0,'config','config_weight_class_id','1',0),(543,0,'config','config_length_class_id','1',0),(542,0,'config','config_currency_auto','1',0),(541,0,'config','config_currency','BDT',0),(540,0,'config','config_admin_language','en',0),(537,0,'config','config_country_id','18',0),(538,0,'config','config_zone_id','322',0),(539,0,'config','config_language','en',0),(536,0,'config','config_comment','',0),(535,0,'config','config_open','',0),(534,0,'config','config_image','',0),(533,0,'config','config_fax','',0),(532,0,'config','config_telephone','123456789',0),(531,0,'config','config_email','riyadh4424@gmail.com',0),(530,0,'config','config_geocode','',0),(529,0,'config','config_address','Address 1',0),(528,0,'config','config_owner','Your Name',0),(527,0,'config','config_name','Your Store',0),(526,0,'config','config_layout_id','4',0),(524,0,'config','config_meta_keyword','',0),(525,0,'config','config_template','default',0),(523,0,'config','config_meta_description','Khokakhuki',0),(522,0,'config','config_meta_title','Khokakhuki',0);
...
INSERT INTO `user` VALUES (1,1,'admin','27ee199e77eb72406a9fe131e1aa3bc6cb3caa4f','tFy1p2lLH','John','Doe','riyadh4424@gmail.com','','','103.245.206.118',1,'2016-02-02 14:31:29');
...
-- Dump completed on 2016-02-04  3:17:47
